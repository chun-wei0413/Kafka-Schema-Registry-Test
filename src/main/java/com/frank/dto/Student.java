...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5454885163759666204L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"com.frank.dto\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"grade\",\"type\":\"string\"}]}");
   ...
   */
  public Student(java.lang.CharSequence id, java.lang.CharSequence name, java.lang.CharSequence grade) {
    this.id = id;
    this.name = name;
    this.grade = grade;
  }
   ...
   */
  public static com.frank.dto.Student.Builder newBuilder() {
    return new com.frank.dto.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.frank.dto.Student.Builder newBuilder(com.frank.dto.Student.Builder other) {
    return new com.frank.dto.Student.Builder(other);
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.frank.dto.Student.Builder newBuilder(com.frank.dto.Student other) {
    return new com.frank.dto.Student.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.frank.dto.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.frank.dto.Student other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.frank.dto.Student.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.frank.dto.Student.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.frank.dto.Student.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.frank.dto.Student.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.frank.dto.Student.Builder setGrade(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.frank.dto.Student.Builder clearGrade() {
      grade = null;
